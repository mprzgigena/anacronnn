<template>
  <div class="space-y-6">
    <!-- Header Section -->
    <div class="bg-gradient-to-r from-white via-green-50 to-white shadow-medical rounded-xl p-4 sm:p-6 border-2 border-green-200">
      <div class="sm:flex sm:items-center sm:justify-between">
        <div class="flex items-center space-x-3 mb-4 sm:mb-0">
          <div class="w-10 h-10 bg-gradient-to-br from-green-600 to-emerald-600 rounded-lg flex items-center justify-center shadow-lg">
            <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
            </svg>
          </div>
          <div>
            <h1 class="text-xl sm:text-2xl font-bold text-medical-dark">Gestión de Turnos</h1>
            <p class="text-sm text-gray-600 hidden sm:block">Administra citas médicas y consultas</p>
          </div>
        </div>
      ...
      <div class="text-center space-y-4">
        <div class="relative">
          ...
          <div class="absolute inset-0 flex items-center justify-center">
            <svg class="w-6 h-6 text-green-600 animate-pulse-medical" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
            </svg>
          </div>
        </div>
        <p class="text-green-600 font-medium animate-bounce-subtle">Cargando turnos médicos...</p>
      </div>
    </div>
    ...
    <!-- Turnos List -->
    <div v-else-if="turnosFiltrados.length > 0" class="bg-gradient-to-r from-white to-green-50 shadow-medical rounded-xl overflow-hidden border-2 border-green-200">
      <div class="px-6 py-4 bg-gradient-to-r from-green-50 to-emerald-50 border-b border-green-200">
        <h2 class="text-xl font-semibold text-medical-dark flex items-center">
          ...
          Turnos Programados
          <span class="ml-2 px-3 py-1 bg-green-600 text-white rounded-full text-sm font-medium">
